...
_EXTRACT_SYSTEM = (
    ...
    "- SEPARATE FOODS are separate lines — two DISTINCT foods joined by 'and' or ',' are "
    "SEPARATE even WITHOUT amounts (they are not a NAMED composite dish): 'shrimp and "
    "white rice' → shrimp / rice (TWO); 'chicken, rice, and broccoli' → THREE; 'a burger "
    "AND fries AND a coffee' → three; '175g turkey and 100g rice' → two; '1 egg plus 3/4 "
    "cup egg whites' → two. Only a dish NAMED as one (a bowl/wrap/sandwich/burrito/salad/"
    "smoothie by name) collapses to ONE.\n"
