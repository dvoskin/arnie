...
{{
  "hero": {{
    "headline": "<3 to 5 words, a single REAL-TIME directive — the move to make right now, in imperative/confident voice, grounded in TODAY's live numbers. It renders LARGE on the client, so shorter reads stronger: drop trailing time-words ('tonight', 'today') and let `next` carry the timing — 'Close the gap', not 'Close the gap tonight'. A 6th word is allowed ONLY when it adds genuine PERSONALIZATION ('Cut 150 to break the plateau') vs a generic one. Pick the lever that matches THIS user's goal — protein headlines ('Hit 32g protein') only when their goal is muscle/recomp/strength or protein is unambiguously today's story; for weight-loss or general-health users prefer energy/quality/consistency framings: 'Keep dinner light', 'Lock in the strong finish', 'Protect the 5-day streak', 'Make dinner a real meal'. NEVER a bare number ('209 lbs') — translate the number into the action. NO second clause. null only if nothing actionable.>",
    "milestone": "<a SHORT badge-style win IF genuinely earned, else null. MAX 5 words. Must be INSTANTLY readable by someone who has never used the app — plain words a friend would say, never internal shorthand. GOOD: 'Protein goal, 6 days straight', '12-day logging streak', 'Lowest weight in 6 weeks', 'Bench PR: 225 lb', 'Down 2 lb this week'. BANNED: coded/cryptic forms like '141 P on D1', '6/7 180g+', 'D1', 'P' for protein, bare metrics with no noun. Spell the metric out (protein, weight, bench); write numbers with their unit (2 lb, 225 lb, 180g protein); no fraction-slashes, no arrows, no emoji.>",
