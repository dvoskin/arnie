...
MUSCLES: dict[str, dict] = {
    "chest_upper":   {"name": "Upper Chest",      "group": "major", "tau_hours": 36.0, "size_weight": 0.85},
    "chest_mid":     {"name": "Mid Chest",        "group": "major", "tau_hours": 38.0, "size_weight": 1.0},
    "chest_lower":   {"name": "Lower Chest",      "group": "major", "tau_hours": 36.0, "size_weight": 0.8},
    "lats":          {"name": "Lats",             "group": "major", "tau_hours": 40.0, "size_weight": 1.0},
    "mid_back":      {"name": "Mid Back",         "group": "major", "tau_hours": 40.0, "size_weight": 0.9},
    "lower_back":    {"name": "Lower Back",       "group": "major", "tau_hours": 44.0, "size_weight": 0.8},
    "delts_front":   {"name": "Front Delt",       "group": "minor", "tau_hours": 22.0, "size_weight": 0.55},
    "delts_side":    {"name": "Side Delt",        "group": "minor", "tau_hours": 22.0, "size_weight": 0.55},
    "delts_rear":    {"name": "Rear Delt",        "group": "minor", "tau_hours": 20.0, "size_weight": 0.45},
    "quads":         {"name": "Quads",            "group": "major", "tau_hours": 40.0, "size_weight": 1.0},
    "hamstrings":    {"name": "Hamstrings",       "group": "major", "tau_hours": 40.0, "size_weight": 0.95},
    "glutes_max":    {"name": "Glute Max",        "group": "major", "tau_hours": 40.0, "size_weight": 0.95},
    "glutes_med":    {"name": "Glute Med",        "group": "major", "tau_hours": 34.0, "size_weight": 0.6},
    "biceps_long":   {"name": "Biceps (Long)",    "group": "minor", "tau_hours": 18.0, "size_weight": 0.5},
    "biceps_short":  {"name": "Biceps (Short)",   "group": "minor", "tau_hours": 18.0, "size_weight": 0.5},
    "brachialis":    {"name": "Brachialis",       "group": "minor", "tau_hours": 18.0, "size_weight": 0.35},
    "triceps_long":  {"name": "Triceps (Long)",   "group": "minor", "tau_hours": 20.0, "size_weight": 0.6},
    "triceps_lateral": {"name": "Triceps (Lateral)", "group": "minor", "tau_hours": 20.0, "size_weight": 0.55},
    "triceps_medial": {"name": "Triceps (Medial)", "group": "minor", "tau_hours": 18.0, "size_weight": 0.45},
    "forearms":      {"name": "Forearms",         "group": "minor", "tau_hours": 16.0, "size_weight": 0.35},
    "traps_upper":   {"name": "Upper Traps",      "group": "minor", "tau_hours": 18.0, "size_weight": 0.55},
    "traps_mid":     {"name": "Mid Traps",        "group": "minor", "tau_hours": 18.0, "size_weight": 0.45},
    "traps_lower":   {"name": "Lower Traps",      "group": "minor", "tau_hours": 18.0, "size_weight": 0.4},
    "abs_upper":     {"name": "Upper Abs",        "group": "minor", "tau_hours": 12.0, "size_weight": 0.45},
    "abs_lower":     {"name": "Lower Abs",        "group": "minor", "tau_hours": 12.0, "size_weight": 0.45},
    "obliques":      {"name": "Obliques",         "group": "minor", "tau_hours": 13.0, "size_weight": 0.4},
    "calves_gastroc": {"name": "Calf (Gastroc)",  "group": "minor", "tau_hours": 18.0, "size_weight": 0.5},
    "calves_soleus": {"name": "Calf (Soleus)",    "group": "minor", "tau_hours": 20.0, "size_weight": 0.4},
}
